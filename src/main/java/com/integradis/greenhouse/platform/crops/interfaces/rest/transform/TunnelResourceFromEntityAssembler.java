...
public class TunnelResourceFromEntityAssembler {
    public static TunnelResource toResourceFromEntity(Tunnel entity){
        return new TunnelResource(entity.getId(), entity.getThermocoupleOne(), entity.getThermocoupleTwo(), entity.getThermocoupleThree(), entity.getAverageThermocouple(), entity.getMotorFrequency(), entity.getRoomTemperature(), entity.getFreshAir(), entity.getRecirculation(), entity.getComment());
    }
}
